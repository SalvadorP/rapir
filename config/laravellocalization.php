...
return [
    ...
    'supportedLocales' => [
        ...
        'en'          => ['name' => 'English',                'script' => 'Latn', 'native' => 'English', 'regional' => 'en_GB', 'class' => 'flag-icon flag-icon-gb'],
        ...
        'es'          => ['name' => 'Spanish',                'script' => 'Latn', 'native' => 'Español', 'regional' => 'es_ES', 'class' => 'flag-icon flag-icon-es'],
